...
| File | Description |
|---|---|
| [`05_output/report/Analysts_Earnings_Forecast_AUC_Report_FINAL.pdf`](05_output/report/Analysts_Earnings_Forecast_AUC_Report_FINAL.pdf) | **Final report — start here** |
| [`05_output/report/AUC_results_tables.xlsx`](05_output/report/AUC_results_tables.xlsx) | Main Excel workbook (11 sheets) |
| [`05_output/tables/07_quality_checks.csv`](05_output/tables/07_quality_checks.csv) | 14 QA checks, all PASS |
| [`05_output/additional_diagnostics/MASTER_TABLE_professor_ready.csv`](05_output/additional_diagnostics/MASTER_TABLE_professor_ready.csv) | Validation summary (17 rows mapping each potential concern to its test and result) |
| [`05_output/forensic_validation/FORENSIC_SUMMARY.csv`](05_output/forensic_validation/FORENSIC_SUMMARY.csv) | Forensic stress-test results (30 checks) |
| [`05_output/figures/roc_curve_main_score_le_2.png`](05_output/figures/roc_curve_main_score_le_2.png) | Main ROC curve |
...
> Step 8 runs `09_quality_checks.py` before Step 9 runs `08_make_report.py`
> so the report can embed the QA results. This is intentional.
...
**Not in repo** (WRDS licensing — regenerated by the pipeline on re-run):
`03_raw/`, `04_intermediate/`, `01_input/3.23_rerestart/02_raw/`,
`01_input/3.23_rerestart/03_intermediate/`, `06_logs/`. See `.gitignore`
for the full list.
